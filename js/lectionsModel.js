define("lectionsModel",[], function (){
    return function lectionsModel () {
        this.lections = [
                            {
                              "id":35,
                              "lector_id":188,
